...
type Transactor interface {
	...
	WithoutTransaction(ctx context.Context, fn func(repo Repository) error) error
}
...
func (txm *TxManager) WithoutTransaction(ctx context.Context, fn func(repo Repository) error) error {
	repo := NewRepositories(txm.pool)
