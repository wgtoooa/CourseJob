...
func (s *AttendanceService) GetPlanByCourse(ctx context.Context, course int) ([]domain.PlanItem, error) {
...
func (s *AttendanceService) UpsertPlanItem(ctx context.Context, input PlanUpsertInput) error {
